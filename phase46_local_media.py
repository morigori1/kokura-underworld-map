...
SLUG_TO_PREFCITY = {
    ...
    # Phase 53 regional chaos
    'kobe_beef': ('兵庫県', '神戸市'),
    'akashi_yaki': ('兵庫県', '神戸市'),
    'vissel_kobe': ('兵庫県', '神戸市'),
    'nada_sake': ('兵庫県', '神戸市'),
    'kobe_jazz_birthplace': ('兵庫県', '神戸市'),
    'kobe_kitano_ijinkan': ('兵庫県', '神戸市'),
    'takoyaki_aizuya': ('大阪府', '大阪市'),
    'osaka_okonomiyaki': ('大阪府', '大阪市'),
    'osaka_dotombori': ('大阪府', '大阪市'),
    'osaka_tsutenkaku': ('大阪府', '大阪市'),
    'downtown_amagasaki': ('兵庫県', None),
    'tenjin_matsuri': ('大阪府', '大阪市'),
    'kishiwada_danjiri': ('大阪府', None),
    'kyo_ryori': ('京都府', '京都市'),
    'yatsuhashi_1689': ('京都府', '京都市'),
    'gion_matsuri': ('京都府', '京都市'),
    'aoi_matsuri': ('京都府', '京都市'),
    'kyoto_sanga': ('京都府', '京都市'),
    'nagoya_misokatsu': ('愛知県', '名古屋市'),
    'nagoya_kishimen': ('愛知県', '名古屋市'),
    'chunichi_dragons': ('愛知県', '名古屋市'),
    'nagoya_castle': ('愛知県', '名古屋市'),
    'ichiro_toyoyama': ('愛知県', None),
    'ginza_kabukiza': ('東京都', None),
    'asakusa_sanja': ('東京都', None),
    'kanda_matsuri': ('東京都', None),
    'ueno_pandapark': ('東京都', None),
    'tower_records_shibuya': ('東京都', None),
    'hakata_ramen': ('福岡県', '福岡市'),
    'hakata_motsunabe': ('福岡県', '福岡市'),
    'hakata_yamakasa': ('福岡県', '福岡市'),
    'hakata_dontaku': ('福岡県', '福岡市'),
    'softbank_hawks': ('福岡県', '福岡市'),
    'tamori_birthplace': ('福岡県', '福岡市'),
    'kurume_ramen_1947': ('福岡県', '久留米市'),
    'bridgestone_kurume_1931': ('福岡県', '久留米市'),
    'matsuda_seiko_kurume': ('福岡県', '久留米市'),
    'checkers_kurume': ('福岡県', '久留米市'),
    'shurijo_2019_fire': ('沖縄県', '那覇市'),
    'okinawa_cuisine': ('沖縄県', '那覇市'),
    'eisa_okinawa': ('沖縄県', '那覇市'),
    'amuro_namie_naha': ('沖縄県', '那覇市'),
    'kokusai_dori': ('沖縄県', '那覇市'),
    # Manila chaos sites - 海外 = phase47 でカバー
    'manila_jollibee': (None, None),
    'manila_jeepney': (None, None),
    'manila_intramuros': (None, None),
    # Phase 54 hangure / intl chaos
    'nishiazabu_intersection': ('東京都', None),
    'roppongi_hills_2003': ('東京都', None),
    'azabu_juban': ('東京都', None),
    'ikebukuro_kitaguchi': ('東京都', None),
    'nishi_kasai_chinese': ('東京都', None),
    'kawaguchi_chinatown': ('埼玉県', None),
    # Overseas — phase47 でカバー
    'manila_makati': (None, None),
    'manila_quiapo': (None, None),
    'manila_bgc': (None, None),
    'phnom_penh_palace': (None, None),
    'phnom_penh_bkk1': (None, None),
    'sihanoukville_china': (None, None),
    'yangon_old_town': (None, None),
    'myawaddy_kk_park': (None, None),
    'bangkok_sukhumvit': (None, None),
    'pattaya_walking_street': (None, None),
    'bangkok_asok': (None, None),
    'hanoi_old_quarter': (None, None),
    'hochiminh_ben_thanh': (None, None),
    'hanoi_lotte_japan': (None, None),
    'vientiane_mekong_riverside': (None, None),
    'vientiane_patuxai': (None, None),
    'busan_port': (None, None),
    'seoul_itaewon': (None, None),
    'seoul_gangnam': (None, None),
    'hk_mongkok': (None, None),
    'hk_wan_chai': (None, None),
