...
SITES = [
    ...
    # ===== Phase 44 — Tokuryu 全国分布の細部 + 最新事案 =====
    ('hamamatsu_kasai_visit',
     '浜松市 — 闇バイト下見事案(2024-10-21)',
     6, 34.7108, 137.7261, 3000,
     'attack_site', '2024-10-21', None, 'active',
     '静岡県浜松市浜名区 — 全国家計構造調査員を装った訪問事案。'
     '2024-10-21 午後2時頃、170cm 痩せ型 30-40代男が住宅を訪問、'
     '住民の所得・隣家構成を尋ねた。'
     '関東広域連続強盗の下見として静岡県警が警戒強化、'
     '同11-12月に静岡中央警察署・静岡市が防犯訓練を実施。',
     '解体後', 'トクリュウ'),

    ('npa_tokuryu_analysis_room',
     '警察庁 トクリュウ情報分析室(2025-10)',
     6, 35.6745, 139.7547, 50,
     'landmark', '2025-10', None, 'active',
     '東京千代田区霞が関2-1-2 警察庁本庁内 — '
     '2025年10月設置のトクリュウ情報分析室。'
     '全国の捜査情報を集約。警視庁の専従部門と合わせ 3,000 人規模で対応。'
     '指揮役・主犯の摘発が1割にとどまる現状(主犯摘発困難)を改善する組織改編の核心。',
     '解体後', '司法側'),

    ('mpd_tokuryu_specialist',
     '警視庁 トクリュウ専従部門(2025-10)',
     6, 35.6770, 139.7508, 50,
     'landmark', '2025-10', None, 'active',
     '東京千代田区霞が関2-1-1 警視庁本部 — '
     '2025年10月設置の専従部門。全国の警察から人員を集めて捜査戦略を立案。'
     '警察庁情報分析室と一体運用。',
     '解体後', '司法側'),

    ('undercover_yamiarbeit',
     '警察官闇バイト潜入捜査(2025-01-)',
     6, 35.6745, 139.7547, 100,
     'lore_site', '2025-01', None, 'active',
     '2025年1月から始まった警察官の闇バイト募集応募による潜入捜査。'
     '同年中に13件で5人を強盗予備・詐欺未遂等で逮捕。'
     '事件発生前に犯罪集団と接触し検挙する新手法。',
     '解体後', '司法側'),

    ('crypto_mixing_takedown_2025',
     '仮想通貨ミキシング マネロン摘発(2025-04-22)',
     6, 35.6770, 139.7508, 100,
     'attack_site', '2025-04-22', None, 'active',
     '東京 警視庁捜査2課 — 37歳男ら3人を詐欺容疑で逮捕。'
     'トクリュウ犯罪収益を仮想通貨ミキシング(複数ルートを混ぜて再分配)で '
     'マネロンしていた。22億円分の取引疑い。'
     '警察庁サイバー特別捜査部が暗号資産口座を一つずつ追跡。',
     '解体後', 'トクリュウ'),

    ('account_provider_takedown_2025',
     '900口座提供 「日本最大」調達組織摘発(2025-10)',
     6, 35.6745, 139.7547, 100,
     'attack_site', '2025-10', None, 'active',
     '東京 — 特殊詐欺グループに約900口座を提供していた「日本最大」の '
     '銀行口座調達組織を警察が摘発。'
     'トクリュウ犯罪インフラ(犯罪収益受け皿口座)への打撃事案。',
     '解体後', 'トクリュウ'),

    ('fukuchi_yamiarbeit_trial',
     '福地容疑者(26)指示役 公判(2024-10無期懲役)',
     6, 35.6745, 139.7547, 200,
     'ruling', '2024-10', None, 'active',
     '東京地裁 — 闇バイト連続強盗団指示役 福地容疑者(26)の公判。'
     '16歳の頃にスーパーで高3少年を暴行死させ少年刑務所へ。'
     '出所後も事件を繰り返し、闇バイト指示役として再逮捕。'
     '一審後のやり直し裁判で無期懲役判決(2024-10)。'
     'トクリュウ指示役の量刑判断事例として参照される。',
     '解体後', 'トクリュウ'),

    ('shutoken_serial_2024',
     '首都圏連続強盗事件(2024-08-27〜11-03 / 19件46人)',
     6, 35.6762, 139.6503, 50000,
     'attack_site', '2024-08-27', '2024-11-03', 'active',
     '東京・埼玉・千葉・神奈川の1都3県で19事件発生。'
     '2024-12-03時点で 16事件・46人を逮捕。'
     'SNS 闇バイト募集を実行役とした典型的トクリュウ事案。'
     'ルフィ事件(2023-01)から1年半経過しても手口・規模が継続したことを示した。',
     '解体後', 'トクリュウ'),

    ('kinpaku_strong_22pref',
     '緊縛強盗 22都道府県78件(2021-09〜2024-03)',
     6, 36.0, 138.0, 500000,
     'lore_site', '2021-09', '2024-03', 'active',
     '2021年9月から2024年3月までの間に 22 都道府県で 78 件の緊縛強盗事件。'
     '関東中心から関西・中部・九州への全国拡散の証左。'
     '指示役グループの標的選定が地理的に拡散した推移を示す。',
     '解体後', 'トクリュウ'),

    ('hakusho_2024_arrests_10k',
     '警察白書 — トクリュウ検挙 11,105人(2024年)',
     6, 35.6745, 139.7547, 100,
     'lore_site', '2024', None, 'active',
     '2024年の1年間でトクリュウ関連犯罪の検挙人員 11,105人。'
     '同年の暴力団構成員検挙人員 8,249人を上回り、'
     '指定暴力団の規模をトクリュウ系犯罪が超えた節目の年。'
     '警察白書(2025年版)の特集テーマとして取り上げられた。',
     '解体後', '司法側'),

    ('kyoto_jewelry_robbery',
     '京都 貴金属店襲撃(ルフィ事件指示)',
     6, 35.0116, 135.7681, 800,
     'attack_site', '2023', None, 'active',
     '京都市 — ルフィ事件 指示役が指示した 14件の襲撃に含まれる '
     '貴金属店襲撃事件。'
     'Telegram など自動消滅 SNS 経由の指示構造が司法で立証された事案。',
     '解体後', 'トクリュウ'),

    ('osaka_serial_2024',
     '大阪府内 連続強盗事件(2024-)',
     6, 34.6937, 135.5023, 30000,
     'attack_site', '2024', None, 'active',
     '大阪府内では2024年以降、トクリュウ型強盗が断続的に発生。'
    ...
    ('saga_periphery_tokuryu',
     '佐賀県内 トクリュウ事案(2024-)',
     6, 33.2494, 130.2989, 30000,
     'attack_site', '2024', None, 'active',
     '佐賀県内のトクリュウ事案。福岡県警・長崎県警と合同連携で対応。'
     '九州抗争(2006-2013)の経験を活かした県警の組織犯罪対策能力が活用される。',
     '解体後', 'トクリュウ'),

    ('nagasaki_tokuryu',
     '長崎県内 トクリュウ事案(2024-)',
     6, 32.7503, 129.8780, 30000,
     'attack_site', '2024', None, 'active',
     '長崎県内のトクリュウ事案。'
    ...
    ('oita_tokuryu',
     '大分県内 トクリュウ事案(2024-)',
     6, 33.2382, 131.6126, 30000,
     'attack_site', '2024', None, 'active',
     '大分県内のトクリュウ事案。'
     '中津市は工藤組初代発祥地でもあり、現代型組織犯罪との地理的接続。',
     '解体後', 'トクリュウ'),

    ('okayama_tokuryu',
     '岡山県内 トクリュウ事案(2024-)',
     6, 34.6618, 133.9344, 30000,
     'attack_site', '2024', None, 'active',
     '岡山県内のトクリュウ事案。'
    ...
    ('laos_tokuryu_base',
     'ラオス拠点 — 日本人被害者保護事案(2024-)',
     6, 17.9757, 102.6331, 10000,
     'lore_site', '2024', None, 'active',
    ...
    ('shizuoka_kenkei_drills',
     '静岡県警 — 住宅防犯訓練(2024-11)',
     6, 34.9756, 138.3826, 500,
     'lore_site', '2024-11', '2024-12', 'active',
     '静岡市 — 関東広域連続強盗を受けて、静岡中央警察署・静岡市が '
     '住宅防犯対策訓練を実施。'
     '強盗訓練・ガラス防犯製品の実演など、'
     '関東以外の県警の対応モデルケース。',
     '解体後', '県警側'),
