...
const TOUR_CATEGORIES = [
  ...
  },
  {
    ...
    tours: [
      ...
      { id: 'hiroshima_yakuza', title: '広島抗争・仁義なき戦い・孤狼の血(全 9 ステップ)', desc: '1945 原爆→1963-1972 抗争→1973 仁義なき戦い→2018 孤狼の血',
        steps: [
          { slug: 'hiroshima_atomic_park', banner: '広島抗争 — 原爆からの戦後' },
          { slug: 'hiroshima_yakuza_war' },
          { slug: 'hiroshima_kyoseikai_hq' },
          { slug: 'hiroshima_nagarekawa' },
          { slug: 'hiroshima_kyoseikai_offshoots' },
          { slug: 'hiroshima_kyoseikai_designation' },
          { slug: 'hiroshima_jingi_movie' },
          { slug: 'hiroshima_korou_no_chi' },
          { slug: 'hiroshima_keisatsu' },
        ]},
      { id: 'okinawa_history', title: '沖縄ヤクザ史 — 米軍・旭琉会・現代(全 8 ステップ)', desc: '1945 米軍統治→旭琉会結成→1972 復帰→コザ→現代',
        steps: [
          { slug: 'okinawa_us_military_yakuza', banner: '沖縄 — 米軍統治と組織犯罪の交点' },
          { slug: 'koza_okinawa' },
          { slug: 'okinawa_kyokuryukai_main' },
          { slug: 'compare_kyokuryukai_hq' },
          { slug: 'kokusai_dori' },
          { slug: 'okinawa_cuisine' },
          { slug: 'eisa_okinawa' },
          { slug: 'shurijo_2019_fire' },
        ]},
    ]
  },
  {
    ...
    color: '#16a085',
    tours: [
      { id: 'kokura_culture', title: '小倉の食・祭・出身著名人(全 12 ステップ)', desc: '焼きうどん発祥→ぬか炊き→旦過→資さんうどん→祭→松本零士・北条司',
        steps: [
          { slug: 'yakiudon_origin', banner: '小倉の街色 — 食 + 祭 + 文化' },
          { slug: 'nukadakimoto' },
          { slug: 'tanga_market' },
          { slug: 'sasashi_udon_first' },
          { slug: 'horumon_district_sakaimachi' },
          { slug: 'moji_yaki_curry' },
          { slug: 'kokura_jigon_drum' },
          { slug: 'tobata_giant_yamagasa' },
          { slug: 'wasshoi_summer_festival' },
          { slug: 'matsumoto_leiji_birthplace' },
          { slug: 'hojo_tsukasa_birthplace' },
          { slug: 'giravanz_kitakyushu' },
        ]},
      { id: 'national_food', title: '全国の食文化 — ヤクザ史の隣の街(全 8 ステップ)', desc: '小倉焼きうどん→博多ラーメン→久留米ラーメン発祥→神戸ビーフ→大阪たこ焼き→京料理→名古屋味噌カツ→沖縄料理',
        steps: [
          { slug: 'yakiudon_origin', banner: '全国の街色 — 食文化を巡る' },
          { slug: 'hakata_ramen' },
          { slug: 'kurume_ramen_1947' },
          { slug: 'kobe_beef' },
          { slug: 'takoyaki_aizuya' },
          { slug: 'kyo_ryori' },
          { slug: 'nagoya_misokatsu' },
          { slug: 'okinawa_cuisine' },
        ]},
      { id: 'intl_diaspora', title: '海外日本人街 — トクリュウ拠点の表側(全 7 ステップ)', desc: 'リトル東京(Makati)→Bicutan→バンコク・スクンビット→ハノイ→プノンペン→ヴィエンチャン→梨泰院',
        steps: [
          { slug: 'manila_makati', banner: '海外日本人街 — トクリュウ拠点の隣' },
          { slug: 'philippines_luffy_base' },
          { slug: 'bangkok_sukhumvit' },
          { slug: 'hanoi_lotte_japan' },
          { slug: 'phnom_penh_bkk1' },
          { slug: 'vientiane_mekong_riverside' },
          { slug: 'seoul_itaewon' },
        ]},
    ]
  },
